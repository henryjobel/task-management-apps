...
const Login = () => {
    ...
    return (
        <div className="pb-8">
            <div className="flex flex-col justify-center pt-4 lg:flex-row gap-7">
                <div className="hidden w-1/2 pt-5 mx-auto lg:block">
                    <img src="https://i.ibb.co/vXVXVQD/illustration-people-login.png" alt="" />
                </div>

                <div className="flex-1 w-full max-w-sm p-4 mx-auto text-black bg-gray-100 border border-gray-200 rounded-lg shadow lg:w-1/2 pb-14 sm:p-6 md:p-8 dark:border-gray-700">
                    <form onSubmit={handleLogIn} className="space-y-6">
                        <h5 className="text-xl font-medium text-gray-900 ">Login Here</h5>
                        <div>
